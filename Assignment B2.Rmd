...
#calculate Cronbachs Alpha for reliability
library(psych)

dataset4ca_study1 <- dataset1 %>% 
  select(rank_b_hm_1, rank_b_tg_1, rank_c_hm_1, rank_c_tg_1)

dataset4ca_study1$rank_b_hm_1[is.na(dataset4ca_study1$rank_b_hm_1)] <- 0
dataset4ca_study1$rank_b_tg_1[is.na(dataset4ca_study1$rank_b_tg_1)] <- 0
dataset4ca_study1$rank_c_hm_1[is.na(dataset4ca_study1$rank_c_hm_1)] <- 0
dataset4ca_study1$rank_c_tg_1[is.na(dataset4ca_study1$rank_c_tg_1)] <- 0

alpha(dataset4ca_study1, check.keys=TRUE)
